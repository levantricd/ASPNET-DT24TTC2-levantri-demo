...
## Mục tiêu
Khởi tạo dự án và chuẩn bị môi trường phát triển trên GitHub.
...
- Chưa quen với quy trình quản lý dự án bằng GitHub.
- Đang tìm hiểu cách sử dụng commit và tổ chức tài liệu theo chuẩn.

## Kế hoạch tuần tiếp theo

- Khởi tạo dự án ASP.NET Core MVC.
- Thiết kế cơ sở dữ liệu.
- Tạo các Model và kết nối SQL Server bằng Entity Framework Core.
- Tiếp tục cập nhật tiến độ lên GitHub.

## Ghi chú

Repository đã được tạo và sẽ được cập nhật thường xuyên để theo dõi quá trình phát triển dự án.
